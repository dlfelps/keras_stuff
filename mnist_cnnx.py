...
def train(num_classes=100, epochs=100, reps=1):
    ...
    model.load_weights("saved_cnn.hdf5")
    model.summary()
    ...
    checkpoint = ModelCheckpoint("saved_cnn.hdf5", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=10)
